...
## Cleaning Dataset
```{r load dataset}
datanya <- vroom(here('E:/PRAKTIKUM DS/praktikum2020/projek/projek/women/data_review.csv'))
...
View(dataframe)
write.csv(dataframe,file = 'E:/PRAKTIKUM DS/praktikum2020/projek/projek/women/commentclean.csv')
```
...
datanya<-read.csv("E:/PRAKTIKUM DS/praktikum2020/projek/projek/women/commentclean.csv",stringsAsFactors = FALSE)
...
library(dplyr)
library(caret)
df<-read.csv("E:/PRAKTIKUM DS/praktikum2020/projek/projek/women/commentclean.csv",stringsAsFactors = FALSE)
glimpse(df)
...
bajuu<- vroom(here("E:/PRAKTIKUM DS/praktikum2020/projek/projek/women/commentclean.csv"))
baju<- bajuu$text
ui <- fluidPage(
    titlePanel("Analisa"),
        mainPanel(
...
server <- function(input, output) {
    ...
    output$scatterplot <- renderPlot({produk_dataset<-read.csv("E:/PRAKTIKUM DS/praktikum2020/projek/projek/women/commentclean.csv",stringsAsFactors = FALSE)
